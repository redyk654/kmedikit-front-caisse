...
import { extraireCode, mois, mois2, nomDns } from '../../shared/Globals';
...
export default function Assurance() {
    ...
    useEffect(() => {
        if(clientSelect.length === 1) {
            ...
            clientSelect[0].factures.map(item => {
                ...
                req.open('GET', `${nomDns}gestion_assurance.php?facture=${item}`);
    ...
    useEffect(() => {
        const req = new XMLHttpRequest();
        req.open('GET', `${nomDns}assurances.php?liste`);
    ...
    const miseAjourStatu = () => {
        ...
        clientSelect[0].factures.forEach(item => {
            ...
            const req = new XMLHttpRequest();
            req.open('POST', `${nomDns}gestion_assurance.php`);
            ...
            req.addEventListener('load', () => {
                ...
                if (clientSelect[0].factures.length === i) {
                    ...
                    clientSelect[0].factures.forEach(item => {
                        ...
                        const req2 = new XMLHttpRequest();
                        req2.open('POST', `${nomDns}gestion_assurance.php`);
    ...
    const ajouterAssurance = () => {
        ...
        const req = new XMLHttpRequest();
        req.open('POST', `${nomDns}assurances.php`);
