...
import { convertDate, extraireCode, getDateTime, nomDns, recupererDateJour, recupererHeureJour, mois, ROLES, mois2, formaterNombre } from '../../shared/Globals';
...
export default function ListingFactures(props) {
    ...
    const afficherFactureDetails = (facture) => {
        ...
        // console.log(mois2(facture.date_heure?.substring(0, 10)));
